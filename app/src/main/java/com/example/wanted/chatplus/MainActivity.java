...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main);
            ...
            n91 = (EditText) findViewById(R.id.n911);
            n91.setEnabled(false);
            ...
            if (user != null) {
                ...
                //     "Quote Exceeded", Toast.LENGTH_SHORT).show();
                        ...
                        {
                            {
                                ...
                                final sendV s = new sendV();
                                final String phone = "+91" + phonenumber.getText().toString();
                                s.getN(phone);
                                s.getV(userid);
                                FirebaseDatabase database = FirebaseDatabase.getInstance();
                                final DatabaseReference myRef = database.getReference(phone);
                                ...
                                r.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        Boolean email = dataSnapshot.hasChild(phone);
                                        ...
                                        if(email.equals(false))
                                        {
                                            if(u.setU() == false) {
                                                ...
                                                s.getC(true);
                                                savePreferences(true, MainActivity.this);
                                                Intent intent = new Intent(MainActivity.this, Main_Page.class);
                                                startActivity(intent);
                                                finish();
                                            }
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        switch (uiState) {
            ...
            case STATE_CODE_SENT:
                ...
                resendnn.setVisibility(View.VISIBLE);
                //disableViews(ok);
   ...
   /*     if (user == null)
    ...
    public void sendn(View view) {
        if (isOnline()) {
            ...
            int hasPermission = manager.checkPermission ("android.permission.READ_CONTACTS", "com.example.wanted.chatplus");
            ...
            {
                askForPermission(android.Manifest.permission.READ_CONTACTS, WRITE_EXST);
            }
        } else
            {
            Toast.makeText(MainActivity.this,
